...
CREATE TABLE `law_app_users`  (
  ...
  `user_type` enum('Buyer','Seller') CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT 'Buyer',
...
-- ----------------------------
INSERT INTO `law_lawyers` VALUES (1, 'nirjhar', '2342344', 'sdfae', 'sdfsdf', 'sdfsdf', 'sdfsdf', 1, '2019-12-19 00:00:00', NULL, '2019-12-19 13:37:52', 'Active');
...
CREATE TABLE `law_properties`  (
  ...
  `land_reg_certificate_abuilding_description` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
  ...
  `burden_of_property_bank` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `burden_of_property_number_n_date_of_presentation` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
  ...
  `constitutive_actattachment_path` varchar(150) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `created_by` int(10) NULL DEFAULT NULL,
  `created_at` datetime(0) NULL DEFAULT NULL,
  `updated_by` int(10) NULL DEFAULT NULL,
  `updated_at` timestamp(0) NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP(0),
...
CREATE TABLE `law_properties_burden_of_property`  (
  ...
  `bank` varchar(150) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
INSERT INTO `sys_master_entry_details` VALUES (38, 'law_real_states', 'law_real_states', 'seller_id', 'Seller Id', 'form-label', 'Enter Seller Id', 'text', 3, 'seller_id', 'form-control', NULL, NULL, 0, 0, 'seller', NULL, 'combo', NULL, 0, NULL, NULL, '2019-12-19 17:03:09', 'Active');
...
-- ----------------------------
INSERT INTO `sys_master_grid` VALUES (1, 'master_entry_table', NULL, NULL, NULL, 'SELECT\r\n	master_entry_table_id,\r\n	master_entry_table_name,\r\n	table_sql,\r\n	template_details_view,\r\n	enable_details_view,\r\n	disable_modal,\r\n	master_entry_title,\r\n	export_pdf,\r\n	export_csv,\r\n	export_excel,\r\n	enable_printing,\r\n	disable_grid_view,\r\n	disable_form_view,\r\n	include_search_panel', 'FROM\r\n	master_entry_table', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '1', NULL, NULL, 1, NULL, 0, 1, 0, 0, '2014-12-07 15:13:30', 1, 0, '2019-07-17 13:32:22', 'Active');
INSERT INTO `sys_master_grid` VALUES (2, 'user_level', NULL, NULL, NULL, 'SELECT\r\n	user_level.*', 'FROM\r\n	user_level', 'WHERE\r\n	user_level.user_level_id NOT IN (1, 12)', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '1', NULL, NULL, 1, NULL, 0, 0, 0, 0, '2014-12-07 15:13:30', 1, 0, '2019-07-17 13:32:22', 'Active');
INSERT INTO `sys_master_grid` VALUES (3, 'user_type', NULL, NULL, NULL, 'SELECT\r\n	user_type.*', 'FROM\r\n	user_type', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '1', NULL, NULL, 1, NULL, 0, 0, 0, 0, '2014-12-07 15:13:30', 1, 0, '2019-07-17 13:32:22', 'Active');
INSERT INTO `sys_master_grid` VALUES (4, 'module', NULL, NULL, NULL, 'SELECT\r\n	module.module_id,\r\n	module.module_name,\r\n	module.module_icon,\r\n	module.description,\r\n	module.home_url,\r\n	module.`status`', 'FROM\r\n	module', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '1', NULL, NULL, 1, NULL, 0, 0, 0, 0, '2014-12-07 15:13:30', NULL, 1, '2019-07-17 13:32:22', 'Active');
INSERT INTO `sys_master_grid` VALUES (5, 'dropdown', NULL, NULL, NULL, 'SELECT\r\n	*', 'FROM\r\n	dropdown', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '1', NULL, NULL, 1, NULL, 0, 0, 0, 0, '2017-09-20 18:53:49', 1, 1, '2019-07-17 13:32:22', 'Active');
INSERT INTO `sys_master_grid` VALUES (6, 'search_panel', NULL, NULL, NULL, 'SELECT\r\n	*', 'FROM\r\n	search_panel', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '1', NULL, NULL, 1, NULL, 0, 0, 0, 0, '2017-10-08 12:32:30', 1, 1, '2019-07-17 13:32:22', 'Active');
INSERT INTO `sys_master_grid` VALUES (7, 'user', NULL, NULL, NULL, 'SELECT\r\n	*', 'FROM\r\n	users', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '1', NULL, NULL, 1, NULL, 0, 0, 0, 0, '2017-10-15 15:05:39', 1, 1, '2019-07-17 13:32:22', 'Active');
INSERT INTO `sys_master_grid` VALUES (31, 'currency', NULL, NULL, 'Currency List', 'SELECT *', ' FROM currencys', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '1', NULL, NULL, 1, NULL, 0, 0, 0, 0, NULL, NULL, 0, '2019-07-17 13:32:22', 'Active');
INSERT INTO `sys_master_grid` VALUES (33, 'product_brand', 'product_brand', 'product_brand', 'Product Brand List', 'SELECT product_brands.product_brands_id, product_brands.product_brands_name as product_brand, product_brands.description, product_brands.`status`	', 'FROM product_brands', NULL, NULL, NULL, NULL, NULL, 'product_brands', 'product_brands.product_brands_id', 'product_dropdown_search', '1', 'product_brands.product_brands_name,product_brands.`status`', 'product_brands.product_brands_id', 1, NULL, 0, 0, 0, 0, NULL, NULL, 0, '2019-08-28 18:18:53', 'Active');
INSERT INTO `sys_master_grid` VALUES (49, 'purchase_category', 'purchase_category', NULL, 'Purchase category', 'SELECT * ', 'FROM purchase_categorys', NULL, NULL, NULL, NULL, NULL, 'purchase_categorys', 'purchase_categorys_id', NULL, '1', NULL, NULL, 1, NULL, 0, 0, 0, 0, NULL, NULL, 0, '2019-07-17 13:32:22', 'Active');
INSERT INTO `sys_master_grid` VALUES (51, 'product', NULL, 'create-product', 'Product List', 'SELECT\r\n	products.products_id,\r\n	products.products_name as `Name`,\r\n	product_categorys.product_categorys_name as Category,\r\n	products.description,\r\n	products.operational_group as `group`,\r\n	products.operational_type as `type`,\r\n	products.default_unit_price as `price`,\r\n	products.reorder_qty as `Reorder Qty`,\r\n	products.minimum_order_qty as `Min Order`,\r\n	products.default_uom AS UOM,\r\n  products.`status`', 'FROM\r\n	products\r\nLEFT JOIN product_categorys ON products.product_categorys_id = product_categorys.product_categorys_id', NULL, NULL, NULL, 'ORDER BY products.products_name ASC', NULL, 'products', 'products.products_id', 'product_dropdown_search', '1', 'products.products_name,products.operational_group,products.operational_type,product_categorys.product_categorys_name', 'Name,Category,group', 1, NULL, 0, 0, 0, 0, NULL, NULL, 0, '2019-08-28 18:21:59', 'Active');
INSERT INTO `sys_master_grid` VALUES (52, 'vendor', NULL, 'create-vendor', 'Vendor List', 'SELECT\r\n	vendors.vendors_id,\r\n	vendors.vendors_name,\r\n	vendors.vendors_code,\r\n	CONCAT(\r\n		vendors.cp1_name,\r\n		\'(\',\r\n		vendors.cp1_mobile,\r\n		\')\'\r\n	) contact_person_1,\r\n	CONCAT(\r\n		vendors.cp2_name,\r\n		\' (\',\r\n		vendors.cp2_mobile,\r\n		\')\'\r\n	) contact_person_2,\r\n	vendors.default_currency,\r\n	banks.banks_name,\r\n	bank_branchs.bank_branch_name,\r\n	vendors.bank_account,\r\n	vendors.location,\r\n	countrys.countrys_name,\r\n	vendors.address,\r\n	vendors.`status`', 'FROM\r\n	vendors\r\nLEFT JOIN countrys ON vendors.countrys_id = countrys.countrys_id\r\nLEFT JOIN banks ON vendors.bank_name = banks.banks_id\r\nLEFT JOIN bank_branchs ON vendors.bank_branchs = bank_branchs.bank_branchs_id', NULL, NULL, NULL, 'ORDER BY\r\n	vendors.vendors_id DESC', NULL, 'vendors', 'vendors_id', NULL, '1', NULL, NULL, 1, NULL, 0, 0, 0, 0, NULL, NULL, 0, '2019-07-17 13:32:22', 'Active');
INSERT INTO `sys_master_grid` VALUES (54, 'product_uom', 'product_uom', 'product_uom', 'UoM List', 'SELECT product_uoms_id,product_uoms_name as UoM_name,short_name ,description,`status`', ' FROM product_uoms', NULL, NULL, NULL, 'order by product_uoms_id desc', NULL, 'product_uoms', 'product_uoms_id', NULL, '1', NULL, NULL, 1, NULL, 0, 0, 0, 0, NULL, NULL, 0, '2019-07-17 13:32:22', 'Active');
INSERT INTO `sys_master_grid` VALUES (55, 'product_category', '', 'add-product-category', 'Product category List', 'SELECT \r\nproduct_categorys.product_categorys_id,\r\nproduct_categorys.product_categorys_name as category,\r\nparents.product_categorys_name sub_category,\r\nproduct_categorys.parents as parent_category ', '\r\nFROM\r\n product_categorys\r\nLEFT JOIN product_categorys AS parents ON product_categorys.sub_type_of = parents.product_categorys_id ', 'WHERE\r\n product_categorys.`status` = \'Active\'', NULL, NULL, 'ORDER BY\r\n product_categorys.product_categorys_id DESC', NULL, 'product_categorys', 'product_categorys_id', NULL, '1', NULL, NULL, 1, NULL, 0, 0, 0, 0, NULL, NULL, 0, '2019-07-17 13:32:22', 'Active');
INSERT INTO `sys_master_grid` VALUES (56, 'product_spec_other', 'product_spec_other', 'product_spec_other', 'Product spec other', 'SELECT\r\n	product_spec_others.product_spec_others_id,\r\n	product_spec_others.product_spec_others_name,\r\n	product_spec_others.product_spec_others_value,\r\n	products.products_name,\r\n	product_spec_others.description,\r\n	product_spec_others.`status`', 'FROM\r\n	product_spec_others\r\nLEFT JOIN products ON products.products_id = product_spec_others.products_id', NULL, NULL, NULL, 'ORDER BY\r\n	product_spec_others.product_spec_others_id DESC', NULL, 'product_spec_others', 'product_spec_others_id', NULL, '1', NULL, NULL, 1, NULL, 0, 0, 0, 0, NULL, NULL, 0, '2019-07-17 13:32:22', 'Active');
INSERT INTO `sys_master_grid` VALUES (57, 'product_spec_standard', 'product_spec_standard', 'product_spec_standard', 'Standard Specification List', 'SELECT\r\n	product_spec_standards.product_spec_standards_id,\r\n	product_spec_standards.product_spec_standards_name AS standard_specification,\r\n	products.products_name AS product_name,\r\n	product_spec_standards.spec_unit AS unit,\r\n	product_spec_standards.default_spec AS default_specification,\r\n	product_spec_standards.description,\r\n	product_spec_standards. `status`', 'FROM\r\n	product_spec_standards\r\nLEFT JOIN products ON products.products_id = product_spec_standards.products_id', NULL, NULL, NULL, '\r\nORDER BY\r\n	product_spec_standards.product_spec_standards_id DESC', NULL, 'product_spec_standards', 'product_spec_standards_id', NULL, '1', NULL, NULL, 1, NULL, 0, 0, 0, 0, NULL, NULL, 0, '2019-07-17 13:32:22', 'Active');
INSERT INTO `sys_master_grid` VALUES (59, 'product_model', 'product_model', 'product_model', 'Product Model List', 'SELECT\r\n	product_models_id,\r\n	product_models_name AS model_name,\r\n	description,\r\n	`status`', 'FROM\r\n	product_models', NULL, NULL, NULL, 'ORDER BY\r\n	product_models_id DESC', NULL, 'product_models', 'product_models_id', NULL, '1', NULL, NULL, 1, NULL, 0, 0, 0, 0, NULL, NULL, 0, '2019-07-17 13:32:22', 'Active');
INSERT INTO `sys_master_grid` VALUES (60, 'customer', NULL, 'customer', 'Customer List', 'SELECT\r\n	customers.customers_id,\r\n	customers.customers_code,\r\n	customers.customers_name,\r\n	customer_types.customer_types_name,\r\n	customers.address_billing,\r\n	customers.address_shipping,\r\n	customers.owner_name,\r\n	customers.contact_number,\r\n	customers.email,\r\n	customers.tin_number,\r\n	customers.nid_type,\r\n	customers.nid_number,\r\n	customer_payment_terms.customer_payment_terms_name,\r\n	customers.credit_limit,\r\n	customers.trade_license_number,\r\n	customers.trade_license_expiry,\r\n	customers.`status`', 'FROM\r\n	customers\r\nLEFT JOIN customer_types ON customers.customer_types_id = customer_types.customer_types_id\r\nLEFT JOIN customer_payment_terms ON customers.customer_payment_terms_id = customer_payment_terms.customer_payment_terms_id', NULL, NULL, NULL, 'ORDER BY\r\n	customers_id DESC', NULL, 'customers', 'customers_id', NULL, '1', NULL, NULL, 1, NULL, 0, 0, 0, 0, NULL, NULL, 0, '2019-07-17 13:32:22', 'Active');
INSERT INTO `sys_master_grid` VALUES (62, 'price_list', NULL, 'price-list-create', 'Price List', 'SELECT\r\n	price_list_id,\r\n	price_list_name,\r\n	price_list_code,\r\n	budget_year,\r\n	customer_types_name,\r\n	effective_date,\r\n	price_list_status', 'FROM\r\n	price_list\r\nLEFT JOIN customer_types ON price_list.customer_types_id = customer_types.customer_types_id', NULL, NULL, NULL, 'ORDER BY\r\n	price_list_id DESC', NULL, 'price_list', 'price_list_id', NULL, '1', NULL, NULL, 1, NULL, 0, 0, 0, 0, NULL, NULL, 0, '2019-07-17 13:32:22', 'Active');
INSERT INTO `sys_master_grid` VALUES (63, 'delivery_driver_unused', 'delivery_driver_unused', 'delivery_driver_unused', 'Delivery driver', 'SELECT\r\n	*', '\r\nFROM\r\n	delivery_drivers', NULL, NULL, NULL, 'ORDER BY\r\n	delivery_driver_id DESC', NULL, 'delivery_drivers', 'delivery_drivers_id', NULL, '1', NULL, NULL, 1, NULL, 0, 0, 0, 0, NULL, NULL, 0, '2019-07-17 13:32:22', 'Active');
INSERT INTO `sys_master_grid` VALUES (64, 'delivery_driver', 'delivery_driver', 'delivery_driver', 'Delivery Drivers', 'SELECT\r\n	delivery_drivers_id,\r\n	driver_name,\r\n	mobile,\r\n	address,\r\n	`status`', '\r\nFROM\r\n	`delivery_drivers`', NULL, NULL, NULL, 'ORDER BY\r\n	delivery_drivers_id DESC', NULL, 'delivery_drivers', 'delivery_drivers_id', NULL, '1', NULL, NULL, 1, NULL, 0, 0, 0, 0, NULL, NULL, 0, '2019-07-17 13:32:22', 'Active');
INSERT INTO `sys_master_grid` VALUES (66, 'delivery_van', 'delivery_van', 'delivery_van', 'Delivery van', 'SELECT\r\n	delivery_vans_id,\r\n	van_no,\r\n	driver_name,\r\n	delivery_vans.`status`', 'FROM\r\n	delivery_vans\r\nLEFT JOIN delivery_drivers ON delivery_vans.driver_id = delivery_drivers.delivery_drivers_id', NULL, NULL, NULL, 'ORDER BY\r\n	delivery_vans_id DESC', NULL, 'delivery_vans', 'delivery_vans_id', NULL, '1', NULL, NULL, 1, NULL, 0, 0, 0, 0, NULL, NULL, 0, '2019-07-17 13:32:22', 'Active');
INSERT INTO `sys_master_grid` VALUES (67, 'branch', 'branch', 'branch', 'Branch List', 'SELECT\r\n	branchs_id,\r\n	branchs_name AS branch_name,\r\n	short_name,\r\n	address,\r\n	mobile,\r\n	`status`', '\r\nFROM\r\n	branchs', NULL, NULL, NULL, NULL, NULL, 'branchs', 'branchs_id', NULL, '1', NULL, NULL, 1, NULL, 0, 0, 0, 0, NULL, NULL, 0, '2019-07-17 13:32:22', 'Active');
INSERT INTO `sys_master_grid` VALUES (68, 'customer_type', 'customer_type', 'customer_type', 'Customer type', 'SELECT\r\n	customer_types_id,\r\n	customer_types_name,\r\n	description,\r\n	`status`', 'FROM\r\n	customer_types', NULL, NULL, NULL, 'ORDER BY\r\n	customer_types_id DESC', NULL, 'customer_types', 'customer_types_id', NULL, '1', NULL, NULL, 1, NULL, 0, 0, 0, 0, NULL, NULL, 0, '2019-07-17 13:32:22', 'Active');
INSERT INTO `sys_master_grid` VALUES (69, 'customer_payment_term', 'customer_payment_term', 'customer_payment_term', 'Customer payment term', 'SELECT\r\n	customer_payment_terms_id,\r\n	customer_payment_terms_name,\r\n	credit_duration,\r\n	description', '\r\nFROM\r\n	customer_payment_terms', NULL, NULL, NULL, 'ORDER BY\r\n	customer_payment_terms_id DESC', NULL, 'customer_payment_terms', 'customer_payment_terms_id', NULL, '1', NULL, NULL, 1, NULL, 0, 0, 0, 0, NULL, NULL, 0, '2019-07-17 13:32:22', 'Active');
INSERT INTO `sys_master_grid` VALUES (74, 'acc_tag', 'acc_tag', 'acc_tag', 'Account Tag List', 'SELECT\r\n	acc_tags.acc_tags_id,\r\n	acc_tags.acc_tag_name,\r\n	acc_tags.track_name,\r\n	acc_tags.table_name,\r\n	acc_tags.field_id,\r\n	acc_tags.field_name,\r\n	acc_tags.voucher_ref_field,\r\n	acc_tags.`status`', 'FROM\r\n	acc_tags', NULL, NULL, NULL, NULL, NULL, 'acc_tags', 'acc_tags_id', NULL, '1', NULL, NULL, 1, NULL, 0, 0, 0, 0, NULL, NULL, 0, '2019-07-17 13:32:22', 'Active');
INSERT INTO `sys_master_grid` VALUES (76, 'acc_budget_year', 'acc_budget_year', 'acc_budget_year', 'Budget Year List', 'SELECT\r\nacc_budget_years.acc_budget_years_id,\r\nacc_budget_years.acc_budget_year_name,\r\nacc_budget_years.duration,\r\nacc_budget_years.description,\r\nacc_budget_years.`status`', 'FROM\r\nacc_budget_years', NULL, NULL, NULL, NULL, NULL, 'acc_budget_years', 'acc_budget_years_id', NULL, '1', NULL, NULL, 1, NULL, 0, 0, 0, 0, NULL, NULL, 0, '2019-07-17 13:32:23', 'Active');
INSERT INTO `sys_master_grid` VALUES (78, 'acc_journal_type', 'acc_journal_type', 'acc_journal_type', 'Journal Type List', 'SELECT\r\n	acc_journal_types.acc_journal_types_id,\r\n	acc_journal_types.acc_journal_types_name,\r\n	acc_journal_types.`status`', 'FROM\r\n	acc_journal_types', NULL, NULL, NULL, NULL, NULL, 'acc_journal_types', 'acc_journal_types_id', NULL, '1', NULL, NULL, 1, NULL, 0, 0, 0, 0, NULL, NULL, 0, '2019-07-17 13:32:23', 'Active');
INSERT INTO `sys_master_grid` VALUES (80, 'hr_emp_category', 'hr_emp_category', 'hr_emp_category', 'Employee category List', 'SELECT\r\nhr_emp_categorys.hr_emp_categorys_id,\r\nhr_emp_categorys.hr_emp_category_name AS employee_category_name,\r\nhr_emp_categorys.provision_period AS provision_period_month,\r\nhr_emp_categorys.description', 'FROM `hr_emp_categorys`', 'WHERE\r\nhr_emp_categorys.`status` = \'Active\'', NULL, NULL, 'ORDER BY\r\nhr_emp_categorys.hr_emp_categorys_id DESC', NULL, 'hr_emp_categorys', 'hr_emp_categorys_id', NULL, '1', NULL, NULL, 1, NULL, 0, 0, 0, 0, NULL, NULL, 0, '2019-07-17 13:32:23', 'Active');
INSERT INTO `sys_master_grid` VALUES (81, 'hr_emp_unit', 'hr_emp_unit', 'hr_emp_unit', 'Working Unit  List', 'SELECT\r\n	hr_emp_units.hr_emp_units_id,\r\n	hr_emp_units.hr_emp_unit_name AS working_unit_name,\r\n	hr_emp_units.description,\r\n	hr_emp_units.`status`', '\r\nFROM\r\n	hr_emp_units', NULL, NULL, NULL, 'ORDER BY\r\n	hr_emp_units.hr_emp_units_id DESC', NULL, 'hr_emp_units', 'hr_emp_units_id', NULL, '1', NULL, NULL, 1, NULL, 0, 0, 0, 0, NULL, NULL, 0, '2019-07-17 13:32:23', 'Active');
INSERT INTO `sys_master_grid` VALUES (82, 'hr_emp_section', 'hr_emp_section', 'hr_emp_section', 'Working Section List', 'SELECT\r\n	hr_emp_sections.hr_emp_sections_id,\r\n	hr_emp_sections.hr_emp_section_name AS working_section_name,\r\n	hr_emp_sections.description,\r\n	hr_emp_sections.`status`', 'FROM\r\n	hr_emp_sections', NULL, NULL, NULL, 'ORDER BY\r\n	hr_emp_sections.hr_emp_sections_id DESC', NULL, 'hr_emp_sections', 'hr_emp_sections_id', NULL, '1', NULL, NULL, 1, NULL, 0, 0, 0, 0, NULL, NULL, 0, '2019-07-17 13:32:23', 'Active');
INSERT INTO `sys_master_grid` VALUES (83, 'hr_emp_grade', 'hr_emp_grade', 'hr_emp_grade', 'Employee Grade List', 'SELECT\r\n	hr_emp_grades.hr_emp_grades_id,\r\n	hr_emp_grades.hr_emp_grade_name,\r\n	hr_emp_grades.basic_salary,\r\n	hr_emp_grades.house_rent_amount,\r\n	hr_emp_grades.house_rent,\r\n	hr_emp_grades.min_medical,\r\n	hr_emp_grades.min_tada,\r\n	hr_emp_grades.min_food,\r\n	hr_emp_grades.min_gross,\r\n	hr_emp_grades.yearly_increment,\r\n	CASE\r\nWHEN hr_emp_grades.ot_applicable = 0 THEN\r\n	\'NO\'\r\nELSE\r\n	\'YES\'\r\nEND AS ot_applicable,\r\n CASE\r\nWHEN hr_emp_grades.pf_applicable = 0 THEN\r\n	\'NO\'\r\nELSE\r\n	\'YES\'\r\nEND AS pf_applicable,\r\n CASE\r\nWHEN hr_emp_grades.insurance_applicable = 0 THEN\r\n	\'NO\'\r\nELSE\r\n	\'YES\'\r\nEND AS insurance_applicable,\r\n hr_emp_grades.description,\r\n hr_emp_grades.`status`', 'FROM\r\n	hr_emp_grades', NULL, NULL, NULL, 'ORDER BY\r\n	hr_emp_grades.hr_emp_grades_id DESC', NULL, 'hr_emp_grades', 'hr_emp_grades_id', NULL, '1', NULL, NULL, 1, NULL, 0, 0, 0, 0, NULL, NULL, 0, '2019-07-17 13:32:23', 'Active');
INSERT INTO `sys_master_grid` VALUES (84, 'hr_leave_policy', 'hr_leave_policy', 'hr_leave_policy', 'Employee Leave Policy List', 'SELECT\r\n	hr_leave_policys.hr_leave_policys_id,\r\n	hr_leave_policys.leave_type_policy,\r\n	hr_leave_policys.priority,\r\n	hr_leave_policys.compansation_eligibility,\r\n	hr_leave_policys.casual_leave,\r\n	hr_leave_policys.sick_leave,\r\n	hr_leave_policys.earn_leave,\r\n	hr_leave_policys.leave_without_pay,\r\n	hr_leave_policys.special_leave,\r\n	hr_leave_policys.compansation_leave,\r\n	hr_leave_policys.`status`', 'FROM\r\n	hr_leave_policys', NULL, NULL, NULL, 'ORDER BY\r\n	hr_leave_policys.hr_leave_policys_id DESC', NULL, 'hr_leave_policys', 'hr_leave_policys_id', NULL, '1', NULL, NULL, 1, NULL, 0, 0, 0, 0, NULL, NULL, 0, '2019-07-17 13:32:23', 'Active');
INSERT INTO `sys_master_grid` VALUES (85, 'hr_working_shift', 'hr_working_shift', 'hr_working_shift', 'Working Shift List', 'SELECT\r\n	hr_working_shifts.hr_working_shifts_id,\r\n	hr_working_shifts.shift_name,\r\n	hr_working_shifts.start_time,\r\n	hr_working_shifts.end_time,\r\n	hr_working_shifts.working_hour,\r\n	hr_working_shifts.`status`', 'FROM\r\n	hr_working_shifts', NULL, NULL, NULL, 'ORDER BY\r\n	hr_working_shifts.hr_working_shifts_id DESC', NULL, 'hr_working_shifts', 'hr_working_shifts_id', NULL, '1', NULL, NULL, 1, NULL, 0, 0, 0, 0, NULL, NULL, 0, '2019-07-17 13:32:23', 'Active');
INSERT INTO `sys_master_grid` VALUES (88, 'hr_separation_cause', 'hr_separation_cause', 'hr_separation_cause', 'Hr Separation Cause List', 'SELECT\r\n	*', 'FROM\r\n	hr_separation_causes', NULL, NULL, NULL, NULL, NULL, 'hr_separation_causes', 'hr_separation_causes_id', NULL, '1', NULL, NULL, 1, NULL, 0, 0, 0, 0, NULL, NULL, 0, '2019-07-17 13:32:23', 'Active');
INSERT INTO `sys_master_grid` VALUES (89, 'warehouse', 'warehouse', 'warehouse', 'Warehouse List', 'SELECT\r\n	warehouses.warehouses_id,\r\n	warehouses.warehouses_name,\r\n	warehouses.short_name,\r\n	warehouses.address,\r\n	sys_users.username AS created_by,\r\n	warehouses.created_at,\r\n	warehouses.updated_by,\r\n	warehouses.updated_at,\r\n	warehouses.`status`', 'FROM\r\n	warehouses\r\nINNER JOIN sys_users ON warehouses.created_by = sys_users.id\r\nLEFT JOIN sys_users AS update_users ON update_users.updated_by = sys_users.id', 'WHERE\r\n	warehouses.`status` = \'Active\'', NULL, NULL, NULL, NULL, 'warehouses', 'warehouses_id', NULL, '1', NULL, NULL, 1, NULL, 0, 0, 0, 0, NULL, NULL, 0, '2019-07-17 13:32:23', 'Active');
INSERT INTO `sys_master_grid` VALUES (90, 'bank', 'bank', 'bank', 'Bank', 'SELECT\r\n	banks_id,\r\n	banks_name,\r\n	`status`', 'FROM\r\n	banks', NULL, NULL, NULL, 'ORDER BY\r\n	banks_id DESC', NULL, 'banks', 'banks_id', NULL, '1', NULL, NULL, 1, NULL, 0, 0, 0, 0, NULL, NULL, 0, '2019-07-17 13:32:23', 'Active');
INSERT INTO `sys_master_grid` VALUES (91, 'bank_branch', 'bank_branch', 'bank_branch', 'Bank branch', 'SELECT\r\n	bank_branchs.bank_branchs_id,\r\n	banks.banks_name,\r\n	bank_branchs.bank_branch_name,\r\n	bank_branchs.bank_branch_address,\r\n	bank_branchs.`status`', 'FROM\r\n	bank_branchs\r\nLEFT JOIN banks ON bank_branchs.bank_id = banks.banks_id', NULL, NULL, NULL, NULL, NULL, 'bank_branchs', 'bank_branchs_id', NULL, '1', NULL, NULL, 1, NULL, 0, 0, 0, 0, NULL, NULL, 0, '2019-07-17 13:32:23', 'Active');
INSERT INTO `sys_master_grid` VALUES (93, 'warehouses_test', 'warehouses_test', 'warehouses_test', 'Warehouses test', 'SELECT\r\n	*', 'FROM\r\n	warehouses_tests', NULL, NULL, NULL, NULL, NULL, 'warehouses_tests', 'warehouses_tests_id', NULL, '1', NULL, NULL, 1, NULL, 0, 0, 0, 0, NULL, NULL, 0, '2019-07-17 13:32:23', 'Active');
INSERT INTO `sys_master_grid` VALUES (96, 'address_division', 'address_division', 'address_division', 'Address division', 'SELECT\r\n	address_divisions_id,\r\n	address_divisions_name,\r\n	bn_name,\r\n	`status`', 'FROM\r\n	address_divisions', NULL, NULL, NULL, NULL, NULL, 'address_divisions', 'address_divisions_id', NULL, '1', NULL, NULL, 1, NULL, 0, 0, 0, 0, NULL, NULL, 0, '2019-07-17 13:32:23', 'Active');
INSERT INTO `sys_master_grid` VALUES (97, 'address_district', 'address_district', 'address_district', 'Address district', 'SELECT\r\n	address_districts_id,\r\n	address_districts_name,\r\n	bn_name,\r\n	website,\r\n	`status`', 'FROM\r\n	address_districts', NULL, NULL, NULL, NULL, NULL, 'address_districts', 'address_districts_id', NULL, '1', NULL, NULL, 1, NULL, 0, 0, 0, 0, NULL, NULL, 0, '2019-07-17 13:32:23', 'Active');
INSERT INTO `sys_master_grid` VALUES (100, 'address_upazila', 'address_upazila', 'address_upazila', 'Address upazila', 'SELECT\r\n	address_upazilas.address_upazilas_id,\r\n	address_upazilas_name,\r\n	address_upazilas.bn_name,\r\n	address_districts_name,\r\n	address_upazilas.`status`', '\r\nFROM\r\n	address_upazilas,\r\n	address_districts', 'WHERE\r\n	address_upazilas.address_districts_id = address_districts.address_districts_id\r\nAND address_upazilas.`status` = \'Active\'', NULL, NULL, NULL, NULL, 'address_upazilas', 'address_upazilas_id', NULL, '1', NULL, NULL, 1, NULL, 0, 0, 0, 0, NULL, NULL, 0, '2019-07-17 13:32:23', 'Active');
INSERT INTO `sys_master_grid` VALUES (101, 'department', 'department', 'department', 'Department List', 'SELECT\r\n	departments_id,\r\n	departments_name AS name_of_Department,\r\n	`status`', 'FROM\r\n	departments', 'WHERE\r\n	`status` = \'Active\'', NULL, NULL, NULL, NULL, 'departments', 'departments_id', NULL, '1', NULL, NULL, 1, NULL, 0, 0, 0, 0, NULL, NULL, 0, '2019-07-17 13:32:23', 'Active');
INSERT INTO `sys_master_grid` VALUES (102, 'educational_degree', 'educational_degree', 'educational_degree', 'Educational Degree List', 'SELECT\r\n	educational_degrees_id,\r\n	educational_degrees_name AS name_of_degree,\r\n	educational_qualifications_name AS level_of_education,\r\n	`status`', 'FROM\r\n	educational_degrees', 'WHERE\r\n	`status` = \'Active\'', NULL, NULL, NULL, NULL, 'educational_degrees', 'educational_degrees_id', NULL, '1', NULL, NULL, 1, NULL, 0, 0, 0, 0, NULL, NULL, 0, '2019-07-17 13:32:23', 'Active');
INSERT INTO `sys_master_grid` VALUES (103, 'educational_major', 'educational_major', 'educational_major', 'Educational major', 'SELECT\r\n	educational_majors_id,\r\n	educational_majors_name,\r\n	`status`', '\r\nFROM\r\n	educational_majors', 'WHERE\r\n	`status` = \'Active\'', NULL, NULL, NULL, NULL, 'educational_majors', 'educational_majors_id', NULL, '1', NULL, NULL, 1, NULL, 0, 0, 0, 0, NULL, NULL, 0, '2019-07-17 13:32:23', 'Active');
INSERT INTO `sys_master_grid` VALUES (104, 'educational_qualification', 'educational_qualification', 'educational_qualification', 'Certification List', 'SELECT\r\n	educational_qualifications_id,\r\n	educational_qualifications_name AS certificate_Name,\r\n	`status`', 'FROM\r\n	educational_qualifications', 'WHERE\r\n	`status` = \'Active\'', NULL, NULL, NULL, NULL, 'educational_qualifications', 'educational_qualifications_id', NULL, '1', NULL, NULL, 1, NULL, 0, 0, 0, 0, NULL, NULL, 0, '2019-07-17 13:32:23', 'Active');
INSERT INTO `sys_master_grid` VALUES (105, 'bank_account_type', 'bank_account_type', 'bank_account_type', 'Bank account type', 'SELECT\r\n	bank_account_types_id,\r\n	bank_account_types_name,\r\n	`status`', 'FROM\r\n	bank_account_types', 'WHERE\r\n	`status` = \'Active\'', NULL, NULL, NULL, NULL, 'bank_account_types', 'bank_account_types_id', NULL, '1', NULL, NULL, 1, NULL, 0, 0, 0, 0, NULL, NULL, 0, '2019-07-17 13:32:23', 'Active');
INSERT INTO `sys_master_grid` VALUES (106, 'designation', 'designation', 'designation', 'Designation List', 'SELECT\r\n	designations.designations_id,\r\n	IFNULL(\r\n		designations.designations_name,\r\n		\'N/A\'\r\n	) AS name_of_Designation,\r\n	IFNULL(\r\n		designations.short_name,\r\n		\'N/A\'\r\n	) AS short_Name,\r\n	designations.`status`', 'FROM\r\n	designations', 'WHERE\r\n	`status` = \'Active\'', NULL, NULL, NULL, NULL, 'designations', 'designations_id', NULL, '1', NULL, NULL, 1, NULL, 0, 0, 0, 0, NULL, NULL, 0, '2019-07-17 13:32:23', 'Active');
INSERT INTO `sys_master_grid` VALUES (107, 'hr_emp_nominees_relationship', 'hr_emp_nominees_relationship', 'hr_emp_nominees_relationship', 'LIst of Relationship', 'SELECT\r\n	hr_emp_nominees_relationships_id,\r\n	hr_emp_nominees_relationships_name AS name_of_relationship,\r\n	`status`', 'FROM\r\n	hr_emp_nominees_relationships', 'WHERE\r\n	`status` = \'Active\'', NULL, NULL, NULL, NULL, 'hr_emp_nominees_relationships', 'hr_emp_nominees_relationships_id', NULL, '1', NULL, NULL, 1, NULL, 0, 0, 0, 0, NULL, NULL, 0, '2019-07-17 13:32:23', 'Active');
INSERT INTO `sys_master_grid` VALUES (108, 'hr_education_board', 'hr_education_board', 'hr_education_board', 'Board of Education', 'SELECT\r\nhr_education_boards.hr_education_boards_id,\r\nhr_education_boards.hr_education_boards_name as education_board_name,\r\nhr_education_boards.`status`', 'FROM\r\n	hr_education_boards\r\n', NULL, NULL, NULL, NULL, NULL, 'hr_education_boards', 'hr_education_boards_id', NULL, '1', NULL, NULL, 1, NULL, 0, 0, 0, 0, NULL, NULL, 0, '2019-07-17 13:32:23', 'Active');
INSERT INTO `sys_master_grid` VALUES (109, 'hr_education_category', 'hr_education_category', 'hr_education_category', 'Education category', 'SELECT\r\n	*', 'FROM\r\n	hr_education_categorys', NULL, NULL, NULL, NULL, NULL, 'hr_education_categorys', 'hr_education_categorys_id', NULL, '1', NULL, NULL, 1, NULL, 0, 0, 0, 0, NULL, NULL, 0, '2019-07-17 13:32:23', 'Active');
INSERT INTO `sys_master_grid` VALUES (110, 'hr_education_study_filed', 'hr_education_study_filed', 'hr_education_study_filed', 'Fields of Study  List', 'SELECT\r\n	hr_education_study_fileds.hr_education_study_fileds_id,\r\n	hr_education_study_fileds.hr_education_study_fields_name AS fields_of_study_name,\r\n	hr_education_study_fileds.`status`', 'FROM\r\n	hr_education_study_fileds', NULL, NULL, NULL, NULL, NULL, 'hr_education_study_fileds', 'hr_education_study_fileds_id', NULL, '1', NULL, NULL, 1, NULL, 0, 0, 0, 0, NULL, NULL, 0, '2019-12-19 19:46:42', 'Active');
INSERT INTO `sys_master_grid` VALUES (111, 'hr_education_study_field', 'hr_education_study_field', 'hr_education_study_field', 'Hr education study field', 'SELECT\r\n	*', 'FROM\r\n	hr_education_study_fields', NULL, NULL, NULL, NULL, NULL, 'hr_education_study_fields', 'hr_education_study_fields_id', NULL, '1', NULL, NULL, 1, NULL, 0, 0, 0, 0, NULL, NULL, 0, '2019-07-17 13:32:23', 'Active');
INSERT INTO `sys_master_grid` VALUES (112, 'hr_yearly_leave_policy', 'hr_yearly_leave_policy', 'hr_yearly_leave_policy', 'Yearly leave policy', 'SELECT\r\n	hr_yearly_leave_policys_id,\r\n	hr_yearly_leave_policys_year AS policy_year,\r\n	hr_emp_category_name employee_category,\r\n	hr_yearly_leave_policys_name AS leave_type,\r\n	policy_leave_days,\r\n	is_carry,\r\n	ELT(is_earn_leave, \'Yes\') AS is_earn_leave', 'FROM\r\n	hr_yearly_leave_policys,\r\n	hr_emp_categorys', 'WHERE\r\n	hr_yearly_leave_policys.hr_emp_categorys_id = hr_emp_categorys.hr_emp_categorys_id\r\nAND hr_yearly_leave_policys.`status` = \"Active\"', NULL, NULL, NULL, NULL, 'hr_yearly_leave_policys', 'hr_yearly_leave_policys_id', NULL, '1', NULL, NULL, 1, NULL, 0, 0, 0, 0, NULL, NULL, 0, '2019-07-17 13:32:23', 'Active');
INSERT INTO `sys_master_grid` VALUES (114, 'fam_type', 'fam_type', 'fam_type', 'Asset Type List', 'SELECT\r\n	fam_types_id,\r\n	fam_types_name AS ` Asset Type`,\r\n	`status`', '\r\nFROM\r\n	fam_types', NULL, NULL, NULL, NULL, NULL, 'fam_types', 'fam_types_id', NULL, '1', NULL, NULL, 1, NULL, 0, 0, 0, 0, NULL, NULL, 0, '2019-07-17 13:32:23', 'Active');
INSERT INTO `sys_master_grid` VALUES (115, 'fam_test', 'fam_test', 'fam_test', 'Fam test', 'SELECT *', ' FROM fam_tests', NULL, NULL, NULL, NULL, NULL, 'fam_tests', 'fam_tests_id', NULL, '1', NULL, NULL, 1, NULL, 0, 0, 0, 0, NULL, NULL, 0, '2019-07-17 13:32:23', 'Active');
INSERT INTO `sys_master_grid` VALUES (116, 'hr_company_calendar', 'hr_company_calendar', 'hr_company_calendar', 'Hr company calendar', 'SELECT\r\n	hr_company_calendars_id,\r\n	date_is,\r\n	hr_emp_category_name,\r\n	day_status,\r\n	hr_company_calendars.`status`', 'FROM\r\n	hr_company_calendars,\r\n	hr_emp_categorys', 'WHERE\r\n	hr_company_calendars.hr_emp_categorys_id = hr_emp_categorys.hr_emp_categorys_id\r\nAND hr_company_calendars.`status` = \'Active\'', NULL, NULL, NULL, NULL, 'hr_company_calendars', 'hr_company_calendars_id', NULL, '1', NULL, NULL, 1, NULL, 0, 0, 0, 0, NULL, NULL, 0, '2019-07-17 13:32:23', 'Active');
INSERT INTO `sys_master_grid` VALUES (117, 'fam_depre_method', 'fam_depre_method', 'fam_depre_method', 'Depreciation method List', 'SELECT\r\n	fam_depre_methods_id,\r\n	fam_depre_methods_name AS Depreciation_Method,\r\n	`status`', 'FROM\r\n	fam_depre_methods', NULL, NULL, NULL, NULL, NULL, 'fam_depre_methods', 'fam_depre_methods_id', NULL, '1', NULL, NULL, 1, NULL, 0, 0, 0, 0, NULL, NULL, 0, '2019-07-17 13:32:23', 'Active');
INSERT INTO `sys_master_grid` VALUES (118, 'fam_pos_type', 'fam_pos_type', 'fam_pos_type', 'POS Type List', 'SELECT\r\n	fam_pos_types_id,\r\n	fam_pos_types_name AS POS_Type,\r\n	`status`', 'FROM\r\n	fam_pos_types', NULL, NULL, NULL, NULL, NULL, 'fam_pos_types', 'fam_pos_types_id', NULL, '1', NULL, NULL, 1, NULL, 0, 0, 0, 0, NULL, NULL, 0, '2019-07-17 13:32:23', 'Active');
INSERT INTO `sys_master_grid` VALUES (128, 'hr_emp_bonus_policy', 'hr_emp_bonus_policy', 'hr_emp_bonus_policy', 'Employee Bonus Policy', 'SELECT\r\n	hr_emp_bonus_policys_id,\r\n	hr_emp_category_name,\r\n	hr_emp_bonus_policys.bonus_eligible_based_on,\r\n	hr_emp_bonus_policys.number_of_month,\r\n	hr_emp_bonus_policys.bonus_based_on,\r\n	hr_emp_bonus_policys.bonus_ratio', 'FROM\r\n	hr_emp_bonus_policys,\r\n	hr_emp_categorys', 'WHERE\r\n	hr_emp_bonus_policys.hr_emp_categorys_id = hr_emp_categorys.hr_emp_categorys_id', NULL, NULL, NULL, NULL, 'hr_emp_bonus_policys', 'hr_emp_bonus_policys_id', NULL, '1', NULL, NULL, 1, NULL, 0, 0, 0, 0, NULL, NULL, 0, '2019-07-17 13:32:23', 'Active');
INSERT INTO `sys_master_grid` VALUES (129, 'hr_emp_list', 'hr_emp_list', 'hr_emp_list', 'Employee List', 'SELECT\r\n	`sys_users`.`id`,\r\n	`sys_users`.`name`,\r\n	`sys_users`.`email`,\r\n	`sys_users`.`mobile`,\r\n	`sys_users`.`user_code`,\r\n	`hr_emp_categorys`.`hr_emp_category_name`,\r\n	`hr_emp_units`.`hr_emp_unit_name`,\r\n	`hr_emp_units`.`hr_emp_unit_name`,\r\n	`designations`.`designations_name`,\r\n	`departments`.`departments_name`,\r\n	`hr_emp_grades`.`hr_emp_grade_name`,\r\n	`hr_emp_sections`.`hr_emp_section_name`,\r\n	`sys_users`.`status`', 'FROM\r\n	`sys_users`\r\nLEFT JOIN `hr_emp_categorys` ON `sys_users`.`hr_emp_categorys_id` = `hr_emp_categorys`.`hr_emp_categorys_id`\r\nLEFT JOIN `hr_emp_units` ON `sys_users`.`hr_emp_units_id` = `hr_emp_units`.`hr_emp_units_id`\r\nLEFT JOIN `designations` ON `sys_users`.`designations_id` = `designations`.`designations_id`\r\nLEFT JOIN `departments` ON `sys_users`.`departments_id` = `departments`.`departments_id`\r\nLEFT JOIN `hr_emp_grades` ON `sys_users`.`hr_emp_grades_id` = `hr_emp_grades`.`hr_emp_grades_id`\r\nLEFT JOIN `hr_emp_sections` ON `sys_users`.`hr_emp_sections_id` = `hr_emp_sections`.`hr_emp_sections_id`', 'WHERE\r\n	`is_employee` = 1\r\nAND `sys_users`.`status` != \'Inactive\'', NULL, NULL, 'ORDER BY\r\n	`id` DESC', NULL, 'sys_users', 'id', 'employee_list', '1', NULL, 'user_id', 1, NULL, 0, 0, 0, 0, NULL, NULL, 0, '2019-07-21 15:30:42', 'Active');
INSERT INTO `sys_master_grid` VALUES (130, 'requisition_list', 'requisition_list', NULL, NULL, 'SELECT\r\n	`purchase_requisitions`.`purchase_requisitions_id`,\r\n	`purchase_requisitions`.`purchase_requisitions_code` AS requisitions_code,\r\n	`purchase_requisitions`.`expected_delivery_date` AS expected_delivery,\r\n	`purchase_categorys`.`purchase_categorys_name` AS requisition_type,\r\n	`a`.`name` AS `initiator`,\r\n	`purchase_requisitions`.`created_at` AS `created_date`,\r\n	`sys_delegation_conf`.`step_name` AS `delegation_step`,\r\n	`b`.`name` AS `delegation_location`,\r\n	`purchase_requisitions`.`delegation_initialized` AS send_for_approval,\r\n	`purchase_requisitions`.`delegation_final_approved` AS approved_at,\r\n	`sys_status_flows`.`status_flows_name` AS `status`,\r\n	`purchase_requisitions`.`requisition_for`,\r\n	`purchase_requisitions`.`requisition_status` AS `requisition_status`', 'FROM\r\n	`purchase_requisitions`\r\nINNER JOIN `purchase_categorys` ON `purchase_categorys`.`purchase_categorys_id` = `purchase_requisitions`.`purchase_categorys_id`\r\nINNER JOIN `sys_status_flows` ON `sys_status_flows`.`status_flows_id` = `purchase_requisitions`.`requisition_status`\r\nINNER JOIN `sys_users` AS `a` ON `a`.`id` = `purchase_requisitions`.`created_by`\r\nLEFT JOIN `sys_users` AS `b` ON `b`.`id` = `purchase_requisitions`.`delegation_person`\r\nLEFT JOIN `sys_delegation_conf` ON `purchase_requisitions`.`delegation_for` = `sys_delegation_conf`.`delegation_for`\r\nAND `purchase_requisitions`.`delegation_ref_event_id` = `sys_delegation_conf`.`ref_event_id`\r\nAND `purchase_requisitions`.`delegation_version` = `sys_delegation_conf`.`delegation_version`\r\nAND `purchase_requisitions`.`delegation_step` = `sys_delegation_conf`.`step_number`', 'WHERE\r\n	`purchase_requisitions`.`status` = \'Active\'', 'GROUP BY\r\n	`purchase_requisitions`.`purchase_requisitions_id`', NULL, 'ORDER BY\r\n	`purchase_requisitions`.`purchase_requisitions_id` DESC', NULL, 'purchase_requisitions', 'purchase_requisitions_id', 'purchase_requisition_list', '1, 10,12,13', NULL, 'requisition_status,requisitions_code', 1, NULL, 0, 0, 0, 0, NULL, NULL, 0, '2019-09-12 14:00:11', 'Active');
INSERT INTO `sys_master_grid` VALUES (131, 'vendorwise_cslist_for_po', 'vendorwise_cslist_for_po', NULL, NULL, 'SELECT\r\n	`purchase_cs`.`vendors_id`,\r\n	`vendors`.`vendors_name`,\r\n	`vendors`.`vendors_code`,\r\n	purchase_cs.purchase_cs_id,\r\n	(\r\n		SELECT\r\n			COUNT(\r\n				DISTINCT purchase_cs.purchase_cs_id\r\n			)\r\n		FROM\r\n			purchase_cs pc\r\n		WHERE\r\n			pc.vendors_id = purchase_cs.vendors_id\r\n		AND pc.purchase_cs_status = 8\r\n		AND pc.purchase_orders_code IS NULL\r\n		GROUP BY\r\n			pc.vendors_id\r\n	) AS total_cs,\r\n	(\r\n		SELECT\r\n			COUNT(\r\n				DISTINCT purchase_cs.products_id\r\n			)\r\n		FROM\r\n			purchase_cs pc\r\n		WHERE\r\n			pc.vendors_id = purchase_cs.vendors_id\r\n		AND pc.purchase_cs_status = 8\r\n		AND pc.purchase_orders_code IS NULL\r\n		GROUP BY\r\n			pc.vendors_id\r\n	) AS product_items,\r\nCONCAT(SUM(purchase_cs.cs_approve_qty ), \' \', `purchase_cs`.`uom_name`)  AS total_product', 'FROM\r\n	`purchase_cs`\r\nINNER JOIN `vendors` ON `purchase_cs`.`vendors_id` = `vendors`.`vendors_id`', 'WHERE\r\n	`purchase_cs`.`purchase_cs_status` IN (8)\r\n\r\nAND `purchase_cs`.`is_selected` = 1\r\nAND `purchase_cs`.`status` = \'Active\'\r\nAND purchase_cs.purchase_orders_code IS NULL', 'GROUP BY\r\n	`purchase_cs`.`vendors_id`', NULL, NULL, NULL, 'purchase_cs', 'purchase_cs_id', 'new_po', '1,2', NULL, 'vendors_id', 1, NULL, 0, 0, 0, 0, NULL, NULL, 0, '2019-07-18 15:26:52', 'Active');
INSERT INTO `sys_master_grid` VALUES (132, 'cswise_cslist_for_po', 'cswise_cslist_for_po', NULL, NULL, 'SELECT\r\n	`purchase_cs`.`cs_id`,\r\n	`purchase_cs`.`purchase_cs_id`,\r\n	sys_users.`name` AS creator,\r\n	CONCAT(\r\n		SUM(purchase_cs.cs_approve_qty),\r\n		\' \',\r\n		`purchase_cs`.`uom_name`\r\n	) AS total_product,\r\n	SUM(purchase_cs.proposed_price) AS total_price,\r\n	`purchase_cs`.`created_at`', 'FROM\r\n	`purchase_cs`\r\nINNER JOIN `vendors` ON `purchase_cs`.`vendors_id` = `vendors`.`vendors_id`\r\nINNER JOIN `sys_users` ON `purchase_cs`.`created_by` = `sys_users`.`id`', 'WHERE\r\n	`purchase_cs`.`purchase_cs_status` IN (8)\r\nAND `purchase_cs`.`is_selected` = 1\r\nAND `purchase_cs`.`status` = \"Active\"', 'GROUP BY\r\n	`purchase_cs`.`purchase_cs_id`', NULL, NULL, NULL, 'purchase_cs', 'cs_id', 'new_po', '1', NULL, 'purchase_cs_id', 1, NULL, 0, 0, 0, 0, NULL, NULL, 0, '2019-07-23 18:46:22', 'Active');
INSERT INTO `sys_master_grid` VALUES (133, 'purchase_order_list', NULL, NULL, 'Purchase Order List', 'SELECT\r\n	`purchase_orders`.`purchase_orders_id`,\r\n	`purchase_orders`.`purchase_orders_code` AS po_no,\r\n	`purchase_orders`.`po_case`,\r\n	`purchase_orders`.`created_at` AS po_created_date,\r\n	CASE\r\nWHEN `purchase_orders`.`po_case` = \'CS\' THEN\r\n	`purchase_orders`.`po_case_value`\r\nELSE\r\n	\'\'\r\nEND AS CS_NO,\r\n `vendors`.`vendors_name` AS vendor,\r\n `vendors`.`vendors_code` AS vendor_code,\r\n `purchase_orders`.`request_delivery_date` AS request_date,\r\n `purchase_orders`.`delivery_date`,\r\n `purchase_orders`.`purchase_type`,\r\n CONCAT(\r\n	`purchase_orders`.`purchase_value`, \r\n	\' \',\r\n	`purchase_orders`.`currency_code`\r\n) AS total_amount,\r\n `purchase_orders`.`delegation_initialized` AS sent_for_approval,\r\n `purchase_orders`.`delegation_final_approved` AS approved_at,\r\n `sys_users`.`username` AS delegation_location,\r\n `sys_status_flows`.`status_flows_name` AS `status`,\r\n\r\n `purchase_orders`.`po_case_value`,\r\n `vendors`.`vendors_id`,\r\n `purchase_orders`.`po_status`', '\r\nFROM\r\n	`purchase_orders`\r\nINNER JOIN `vendors` ON `purchase_orders`.`vendors_id` = `vendors`.`vendors_id`\r\nINNER JOIN `sys_status_flows` ON `purchase_orders`.`po_status` = `sys_status_flows`.`status_flows_id`\r\nLEFT JOIN `sys_users` ON `purchase_orders`.`delegation_reliever_id` = `sys_users`.`id`\r\nLEFT JOIN `sys_delegation_conf` ON `purchase_orders`.`delegation_for` = `sys_delegation_conf`.`delegation_for`\r\nAND `purchase_orders`.`delegation_ref_event_id` = `sys_delegation_conf`.`ref_event_id`\r\nAND `purchase_orders`.`delegation_version` = `sys_delegation_conf`.`delegation_version`\r\nAND `purchase_orders`.`delegation_step` = `sys_delegation_conf`.`step_number`', 'WHERE\r\n	`purchase_orders`.`status` = \'Active\' AND `purchase_orders`.`po_case` != \'DPI\'', 'GROUP BY\r\n	`purchase_orders`.`purchase_orders_id`,\r\n	`purchase_orders`.`purchase_orders_code`,\r\n	`sys_users`.`username`', NULL, 'ORDER BY\r\n	`purchase_orders`.`purchase_orders_id` DESC', NULL, 'purchase_orders', 'purchase_orders_id', 'po_list', '1,16,17,18', NULL, 'po_no,po_status,po_case,purchase_type,po_case_value', 1, NULL, 0, 0, 0, 0, NULL, NULL, 0, '2019-09-15 15:44:59', 'Active');
INSERT INTO `sys_master_grid` VALUES (136, 'pi_list', NULL, NULL, NULL, 'SELECT\r\n	`purchase_pis`.`purchase_pi_id` as pi_id, \r\n	`purchase_pis`.`purchase_pis_code` as pi_no, \r\n	`purchase_pis`.`pi_case` as pi_case,\r\n	`purchase_pis`.`purchase_orders_code` as po_no, \r\n	`purchase_pis`.`purchase_cs_id` as cs_no,\r\n	`purchase_pis`.`pi_date` as pi_date, \r\n	`vendors`.`vendors_id`,\r\n	`vendors`.`vendors_name`,\r\n	`vendors`.`vendors_code`,	\r\n	`sys_delegation_conf`.`step_name`,\r\n	`sys_users`.`username`,\r\n	`sys_status_flows`.`status_flows_name`,\r\n	`currencys`.`short_name`,\r\n	`purchase_pis`.`pi_status` AS `status`', 'FROM\r\n	`purchase_pis`\r\nINNER JOIN `vendors` ON `purchase_pis`.`vendors_id` = `vendors`.`vendors_id`\r\nLEFT JOIN `sys_status_flows` ON `purchase_pis`.`pi_status` = `sys_status_flows`.`status_flows_id`\r\nLEFT JOIN `sys_users` ON `purchase_pis`.`delegation_reliever_id` = `sys_users`.`id`\r\nLEFT JOIN `currencys` ON `currencys`.`currencys_id` = `purchase_pis`.`pi_currency`\r\nLEFT JOIN `sys_delegation_conf` ON `purchase_pis`.`delegation_for` = `sys_delegation_conf`.`delegation_for`\r\nAND `purchase_pis`.`delegation_ref_event_id` = `sys_delegation_conf`.`ref_event_id`\r\nAND `purchase_pis`.`delegation_version` = `sys_delegation_conf`.`delegation_version`\r\nAND `purchase_pis`.`delegation_step` = `sys_delegation_conf`.`step_number`', 'WHERE\r\n	`purchase_pis`.`status` = \"Active\"', NULL, NULL, NULL, NULL, 'purchase_pis', 'pi_id', NULL, '1,7,9,13,14', NULL, 'pi_id,pi_no,pi_case,po_no,cs_no,status', 0, NULL, 0, 0, 0, 0, NULL, NULL, 0, '2019-07-29 11:32:20', 'Active');
INSERT INTO `sys_master_grid` VALUES (137, 'stock_statement', NULL, NULL, NULL, 'SELECT	\r\n	product_stock_log.product_stock_log_id,\r\n	product_stock_log.date,\r\n	warehouses.warehouses_name as warehouse,\r\n	products.products_name,\r\n	get_opening_stock(product_stock_log.products_id, product_stock_log.date, product_stock_log.warehouses_id) as opening_stock,	\r\n	SUM(product_stock_log.stockin_qty) AS stock_in,\r\n  SUM(product_stock_log.transfer_qty) AS transfer,\r\n  SUM(product_stock_log.sold_qty) AS sold,\r\n  SUM(product_stock_log.used_qty) AS used,	\r\nSUM(\r\n		get_opening_stock(product_stock_log.products_id, product_stock_log.date, product_stock_log.warehouses_id)+product_stock_log.stockin_qty - ( product_stock_log.transfer_qty + product_stock_log.sold_qty + product_stock_log.used_qty )\r\n	) AS closing_stock', 'FROM\r\nproduct_stock_log\r\nINNER JOIN products ON product_stock_log.products_id = products.products_id\r\nINNER JOIN warehouses ON product_stock_log.warehouses_id = warehouses.warehouses_id', 'WHERE\r\nproduct_stock_log.status = \'Active\'', 'GROUP BY\r\n	product_stock_log.products_id, product_stock_log.date, product_stock_log.warehouses_id', NULL, NULL, NULL, 'product_stock_log', 'product_stock_log_id', 'stock_statement', '1', NULL, NULL, 1, NULL, 0, 0, 0, 0, NULL, NULL, 0, '2019-09-03 14:58:18', 'Active');
INSERT INTO `sys_master_grid` VALUES (139, 'banks', 'banks', 'banks', 'Banks', 'SELECT *', 'FROM banks', NULL, NULL, NULL, NULL, NULL, 'banks', 'banks_id', NULL, '1', NULL, NULL, 1, NULL, 0, 0, 0, 0, NULL, NULL, 0, NULL, 'Active');
INSERT INTO `sys_master_grid` VALUES (140, 'nirjhar', 'nirjhar', 'nirjhar', 'Nirjhar', 'SELECT *', 'FROM nirjhar', NULL, NULL, NULL, NULL, NULL, 'nirjhar', 'nirjhar_id', NULL, '1', NULL, NULL, 1, NULL, 0, 0, 0, 0, NULL, NULL, 0, NULL, 'Active');
INSERT INTO `sys_master_grid` VALUES (142, 'law_lawyers', 'law_lawyers', 'law_lawyers', 'Law lawyers', 'SELECT *', 'FROM law_lawyers', NULL, NULL, NULL, NULL, NULL, 'law_lawyers', 'law_lawyers_id', NULL, '1', NULL, NULL, 1, NULL, 0, 0, 0, 0, NULL, NULL, 0, NULL, 'Active');
INSERT INTO `sys_master_grid` VALUES (143, 'law_notaries', 'law_notaries', 'law_notaries', 'Law notaries', 'SELECT *', 'FROM law_notaries', NULL, NULL, NULL, NULL, NULL, 'law_notaries', 'law_notaries_id', NULL, '1', NULL, NULL, 1, NULL, 0, 0, 0, 0, NULL, NULL, 0, NULL, 'Active');
INSERT INTO `sys_master_grid` VALUES (144, 'law_banks', 'law_banks', 'law_banks', 'Law banks', 'SELECT *', 'FROM law_banks', NULL, NULL, NULL, NULL, NULL, 'law_banks', 'law_banks_id', NULL, '1', NULL, NULL, 1, NULL, 0, 0, 0, 0, NULL, NULL, 0, NULL, 'Active');
INSERT INTO `sys_master_grid` VALUES (146, 'law_real_states', 'law_real_states', 'law_real_states', 'Law real states', 'SELECT *', 'FROM law_real_states', NULL, NULL, NULL, NULL, NULL, 'law_real_states', 'law_real_states_id', NULL, '1', NULL, NULL, 1, NULL, 0, 0, 0, 0, NULL, NULL, 0, NULL, 'Active');
INSERT INTO `sys_master_grid` VALUES (147, 'law_property_type', 'law_property_type', 'law_property_type', 'Law property type', 'SELECT *', 'FROM law_property_type', NULL, NULL, NULL, NULL, NULL, 'law_property_type', 'law_property_type_id', NULL, '1', NULL, NULL, 1, NULL, 0, 0, 0, 0, NULL, NULL, 0, NULL, 'Active');
...
-- ----------------------------
INSERT INTO `sys_users` VALUES (1, '1001', 'nirjhar', 'nirjhar@gmail.com', '$2y$10$Mdpv8wuH7XyOR7OsA.0fQ.Qo6X5zwiitDLxe4LycvegQYRT5IxdVS', '', 0, 'Nirjhar Mandal', NULL, '+8801855149196', '1993-01-04', '', 'Male', 'Married', '', '', '', '', '', '', '/img/users/1.jpg', 'Nikunjo, Uttra, Dhaka', NULL, '2019-01-07', '', 1, 'sWuJACedttrp3IQ4BRpxWonzfSOE4KuvE4W5EPaNJsl8hMHV6roGQdWN5H3s', '2020-01-01 03:50:27', 0, NULL, '2019-05-05 11:15:53', '2019-12-20 16:39:38', 1, 'Active');
