            ...
            <div class="tabs-container">
                <div class="tabs-left">
                    <ul class="nav nav-tabs">
                        ...
                        <li><a class="nav-link" data-toggle="tab" href="#autocomplete">Autocomplete</a></li>
                        ...
                        <li><a class="nav-link" data-toggle="tab" href="#audittrail">Create Audit Trail Log</a></li>
                    </ul>
                    <div class="panel-body p-0">
                        <div class="tab-content col-md-12">
                            ...
                            <div id="autocomplete" class="tab-pane">@include('Documentation.autocomplete')</div>
                            ...
                            <div id="audittrail" class="tab-pane">@include('Documentation.audittrail')</div>
                        </div>
                    </div>
                </div>
            </div>
