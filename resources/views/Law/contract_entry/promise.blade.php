...
<div id="collapseThree" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample">
    <form class="" id="promise_form" enctype="multipart/form-data" action="{{url('save-promise-info')}}" method="post">
        <div class="row py-2">
            ...
            @if(isset($contract_data->promise_contact_attachment_path) && !empty($contract_data))
                <div class="form-group col-md-3 pt-4 ">
                    <div class="btn-group generalfilebox" role="group" aria-label="">
                        <a class="btn btn-sm btn-success"
                           href="{{asset('storage/attachment/'.$contract_data->promise_contact_attachment_path)}}" download target="_blank">
                        ...
                        <a class="btn btn-sm btn-danger delete_file_only text-white" data-style="zoom-in"
                           ...
                           data-pathcolumn="promise_contact_attachment_path"
                           data-path="{{$contract_data->promise_contact_attachment_path ?? ''}}">
