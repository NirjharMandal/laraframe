...
<script src="{{asset('public/js/plugins/sweetalert/sweetalert2.all.min.js')}}"></script>
...
<script src="{{asset('public/js/plugins/Autocomplete/jquery.autocomplete.js')}}"></script>
