                ...
                if (!empty($data_json)){
                    ...
                    foreach ($datas as $key => $datum) {
                        ...
                        <tr>
                            ...
                            <td class="text-left"><input type="text" name="text_title[]" class="form-control" placeholder="Title" value="<?php echo $datum['text_title']; ?>"></td>
                            <td class="text-center"><textarea name="text_content[]" rows="2"  class="form-control" placeholder="Content"><?php echo $datum['text_content']; ?></textarea></td>
